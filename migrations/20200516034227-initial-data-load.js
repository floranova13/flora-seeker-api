  ...
  up: async (queryInterface) => {
    ...
    await queryInterface.bulkInsert('samples', [
      ...
      },
      {
        ...
        familyValues: '{ "producerCoefficient": "5" }',
        slug: 'mellowend'
      },
      {
        name: 'Echor Blossom',
        ...
        rarity: 'common',
        family: 'flourishflora',
        familyValues: '{ "producerCoefficient": "10" }',
        slug: 'echor-blossom'
      },
      {
        name: 'Bogbind',
        ...
        rarity: 'common',
        family: 'flourishflora',
        familyValues: '{ "producerCoefficient": "20" }',
        slug: 'bogbind'
      },
      {
        name: 'Frutebane',
      ...
      },
      {
        ...
        rarity: 'rare',
        family: 'waveskellen',
        familyValues: '{ "cascade": "anomalous" }',
